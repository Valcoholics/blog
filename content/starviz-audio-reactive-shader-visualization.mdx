...
⚠️ **This page is under construction** – Some sections may be incomplete or unclear. Thank you for your patience!

</Callout>

<Callout label="Before you start" variant="info">

👉 This article assumes you have basic knowledge about shaders and GLSL. If not, check out some fundamental shader resources first.
